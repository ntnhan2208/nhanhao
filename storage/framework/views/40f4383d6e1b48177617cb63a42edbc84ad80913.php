...
<head>
    ...
    <link href="<?php echo e(asset('admin/assets/plugins/dropify/css/dropify.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('admin/assets/plugins/filter/magnific-popup.css')); ?>" rel="stylesheet" type="text/css"/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 ml-auto">
                                        <ul class="list-unstyled personal-detail">
                                            ...
                                            <li class="mt-2"><i
                                                        class="dripicons-location text-info font-18 mt-2 mr-2"></i> <b>Location</b>
                                                : USA
                                            </li>
                                        </ul>
                            ...
                            <ul class="nav nav-pills mb-0" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="education_detail_tab" data-toggle="pill"
                                       href="#education_detail">Education</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="portfolio_detail_tab" data-toggle="pill"
                                       href="#portfolio_detail">Portfolio</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <img src="../assets/images/small/user-pro.jpg" alt=""
                                                         class="img-fluid">
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="met-basic-detail">
                                                        ...
                                                        <div class="my-3">
                                                            ...
                                                            <button class="btn btn-outline-primary  px-3">My Portfolio
                                                            </button>
                                                        </div>
                                                ...
                                                <div class="activity">
                                                    ...
                                                    <div class="time-item">
                                                        <div class="item-info">
                                                            ...
                                                            <p class="text-muted mt-3">There are many variations of
                                ...
                                <div class="col-lg-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-4">
                                                    <img src="../assets/images/widgets/education.svg" alt=""
                                                         class="img-fluid">
                                                </div>
                                                <div class="col-8 align-self-center">
                                                    <p class="skill-detail">Contrary to popular belief, Lorem Ipsum is
                                                        ...
                                                        <a class="cbox-gallary1 mfp-image"
                                                           ...
                                                           title="Consequat massa quis">
                                                            <img class="item-container "
                                                                 src="../assets/images/small/img-1.jpg" alt="7"/>
                                                            <div class="item-mask">
                                                        ...
                                                        <a class="cbox-gallary1 mfp-image"
                                                           ...
                                                           title="Vivamus elementum semper">
                                                            <img class="item-container mfp-fade"
                                                                 src="../assets/images/small/img-2.jpg" alt="2"/>
                                                            <div class="item-mask">
                                                                <div class="item-caption">
                                                    ...
                                                    <div class="item-box">
                                                        <a class="cbox-gallary1 mfp-image"
                                                           ...
                                                           title="Quisque rutrum">
                                                            <img class="item-container"
                                                                 src="../assets/images/small/img-3.jpg" alt="4"/>
                                                            <div class="item-mask">
                                                                <div class="item-caption">
                                                ...
                                                <div class="col-lg-4 col-md-6 p-0 nf-item branding design spacing">
                                                    <div class="item-box">
                                                        <a class="cbox-gallary1 mfp-image"
                                                           ...
                                                           title="Tellus eget condimentum">
                                                            <img class="item-container"
                                                                 src="../assets/images/small/img-4.jpg" alt="5"/>
                                                            <div class="item-mask">
                                                                <div class="item-caption">
                                                ...
                                                <div class="col-lg-4 col-md-6 p-0 nf-item branding design spacing">
                                                    <div class="item-box">
                                                        <a class="cbox-gallary1 mfp-image"
                                                           ...
                                                           title="Nullam quis ant">
                                                            <img class="item-container"
                                                                 src="../assets/images/small/img-5.jpg" alt="6"/>
                                                            <div class="item-mask">
                                                                <div class="item-caption">
                                                    ...
                                                    <div class="item-box">
                                                        <a class="cbox-gallary1 mfp-image"
                                                           ...
                                                           title="Sed fringilla mauris">
                                                            <img class="item-container"
                                                                 src="../assets/images/small/img-6.jpg" alt="1"/>
                                                            <div class="item-mask">
                                                                <div class="item-caption">
                                                        ...
                                                        <div class="text-center">
                                                            ...
                                                            <div class="">
                                                                <img src="../assets/images/users/user-10.jpg" alt=""
                                                                     class="rounded-circle thumb-lg mb-2">
                                                    ...
                                                    <div class="carousel-item active">
                                                        <div class="text-center">
                                                            ...
                                                            <div class="">
                                                                <img src="../assets/images/users/user-4.jpg" alt=""
                                                                     class="rounded-circle  thumb-lg mb-2">
                                                                <p class="mb-0 text-primary"><b>- Michael C. Rios</b>
                                                                </p>
                                                                <small class="text-muted">CEO Facebook</small>
                                                            </div>
                                                        </div>
...
<script src="<?php echo e(asset('admin/assets/pages/jquery.profile.init.js')); ?>"></script>

<script src="<?php echo e(asset('admin/assets/plugins/filter/isotope.pkgd.min.js')); ?>"></script>
<script src="<?php echo e(asset('admin/assets/plugins/filter/masonry.pkgd.min.js')); ?>"></script>
<script src="<?php echo e(asset('admin/assets/plugins/filter/jquery.magnific-popup.min.js')); ?>"></script>
<script src="<?php echo e(asset('admin/assets/pages/jquery.gallery.inity.js')); ?>"></script>
...
</html><?php /**PATH D:\TP Tech\chinhchubds\be\chinhchubds\resources\views/web/auth1/profile.blade.php ENDPATH**/ ?>