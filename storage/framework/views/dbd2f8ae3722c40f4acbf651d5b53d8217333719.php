                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="slug" class="form-control" value="<?php echo e(old('slug')); ?>"
                                       placeholder="<?php echo e(trans('site.language.slug_lang')); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="code" class="form-control" value="<?php echo e(old('code')); ?>"
                                       placeholder="<?php echo e(trans('site.language.code_lang')); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label><?php echo e(trans('site.language.flag_lang')); ?></label>
                            <div class="input-group">
                                <input type="text" name="flag" class="form-control" value="<?php echo e(old('flag')); ?>"
                                       placeholder="<?php echo e(trans('site.language.flag_lang')); ?>">
                            </div>
                        </div>
                        <div class="form-group">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\TP Tech\chinhchubds\be\chinhchubds\resources\views/admin/language/add.blade.php ENDPATH**/ ?>