                ...
                <form action="<?php echo e(route('admins.update',$admin->id)); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" name="email" class="form-control" readonly value="<?php echo e($admin->email); ?>">
                        </div>
                    </div>
                    <div class="form-group">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\phoenixCMS\resources\views/admin/admins/profile.blade.php ENDPATH**/ ?>