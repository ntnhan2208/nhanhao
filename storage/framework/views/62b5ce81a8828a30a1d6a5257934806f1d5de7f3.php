...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-lg-6">
            <div class="card mt-3">
                <div class="card-body ">
                    <h4 class="mt-0 header-title"><?php echo e(trans('site.type.update')); ?></h4>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text"
                                                           ...
                                                           value="<?php echo e(old('name['.$v->slug.']', $type->name[$v->slug] ?? null)); ?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control"
                                                           name="slug[<?php echo e($v->slug); ?>]"
                                                           value="<?php echo e($type->slug[$v->slug] ?? null); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <br>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="input-group">
                                                    <textarea name="description[<?php echo e($v->slug); ?>]"
                                                              ...
                                                              cols="30" rows="5">
                                                        <?php echo e(old('description['.$v->slug.']', $type->description[$v->slug] ?? null)); ?>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <select name="is_enabled"
                                        ...
                                        <option value="1" <?php echo e(($type->is_enabled == 1) ? 'selected' : ''); ?>><?php echo e(trans('site.yes')); ?></option>
                                        <option value="0" <?php echo e(($type->is_enabled == 0) ? 'selected' : ''); ?>><?php echo e(trans('site.no')); ?></option>
                                    </select>
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <select name="attribute_group_id[]" class="select2 mb-3 select2-multiple"
                                        ...
                                        <?php $__currentLoopData = $attributeGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attributeGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($attributeGroup->id); ?>"
                                                    <?php if($type->attributeGroups->contains($attributeGroup->id)): ?> selected <?php endif; ?>><?php echo e(Sanitize::getValueLangByLocale($attributeGroup->name)); ?> </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\TP Tech\chinhchubds\be\chinhchubds\resources\views/admin/type/edit.blade.php ENDPATH**/ ?>